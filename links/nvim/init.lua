...
-- Normally, this would be good enough (and it's still required for startup with
-- multiple splits)
...
-- I need to use autocmds to change the highlight groups based on focus.
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- TODO: Change this to be a fuzzyfind lines in all files
