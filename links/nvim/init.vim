...
call plug#begin(stdpath('data') . '/plugged')
  ...
  " TODO: These plugins are all from my old Vim config. Clean it up
  " Colorschemes
  ...
  " Plug 'fatih/vim-go'
  " This is broken for some reason and causes vim to hang on save...
...
" If setting the colorscheme to apprentice fails, it will do so quietly. This is important when installing
" plugins with 'vim +PlugInstall +qall'. These 2 lines will use torte as a fallback
colorscheme torte
silent! colorscheme apprentice

lua << EOF
require'nvim-treesitter.configs'.setup {
  ensure_installed = { "c", "cpp", "dockerfile", "go", "gomod", "help", "html", "make", "markdown", "python", "regex", "vim", "yaml" },
  auto_install = true,
...
"TODO: Everything below this line is from my old vim config. Clean it up.
...
set textwidth=110                            "gq will wrap text at 110, same as colorcolumn
